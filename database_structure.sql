...
CREATE POLICY "Planos são visíveis publicamente" ON "public"."plans" FOR SELECT USING (("is_active" = true));
...
CREATE POLICY "Usuários podem ver seus próprios pagamentos" ON "public"."payments" FOR SELECT USING (("auth"."uid"() = "user_id"));
